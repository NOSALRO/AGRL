...
def cma_run(env, net):
    best_solution = cma.evolution_strategy.fmin(env_run, x0=get_model_params(net), sigma0=0.5, options={"CMA_elitist" : True, "maxfevals" : 20000, "verbose" : True}, args=(env, net))
