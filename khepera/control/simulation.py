...
print(target)
res = cma.evolution_strategy.fmin(run, x0=get_model_params(net), sigma0=0.5, options={'CMA_elitist' : True, "maxfevals" : 3000}, args=(net, distribution, target, m, vae.min, vae.max, 0))

run(res[0], net, distribution, target, m, vae.min, vae.max, 2)
